...
public class PlayerFacadeImpl implements PlayerFacade {
    ...
    public void create(PlayerRequestDto playerRequestDto) {
        ...
        player.setTransfer(player.getExperience() * 100000 / player.getAge());
        player.setPrice(player.getTransfer() * team.getCommission());
        player.setTeam(team);
    ...
    public void update(PlayerRequestDto playerRequestDto, Long id) {
        ...
        player.setExperience(playerRequestDto.getExperience());
        player.setTransfer(player.getExperience() * 100000 / player.getAge());
        player.setPrice(player.getTransfer() * player.getTeam().getCommission());
